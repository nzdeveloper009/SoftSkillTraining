...
fun CompleteRegistrationHeader() {
    ...
    Card14 {
        Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(12.dp)) {
            ...
            Column {
                Text(s.completeRegistration, style = TextStyle(fontSize = 18.sp, fontWeight = FontWeight.Bold, color = TextFg))
                Text(s.completeRegistrationSub, style = TextStyle(fontSize = 12.sp, color = MutedFg, lineHeight = 16.sp))
            }
        }
    }
}